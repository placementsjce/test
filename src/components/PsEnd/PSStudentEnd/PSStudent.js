        ...
        >
          ...
          <div className='companyaddform'>
               ...
               {(studentdetails)? (
                ...
                id="outlined-disabled"
                label="SSC Marks"
                disabled={localStorage.getItem('person')==='ps'?true:false}
...
<div style={{width:'100%',display:'flex',alignItems:'center'}}>
      ...
      <Box sx={{width:'35%',marginTop:'5vh'}} class="oncamp_side">
              <OnCampus/>
          </Box>
      ...
      <Box sx={{  margin: '5vh 0' }}>
            ...
            <div className='header_company'>ADD STUDENT</div>
              ...
              {localStorage.getItem('person')==='admin'?( <Box sx={{  margin: '5vh 0' }}>
