				...
				<div className='container'>
					<div className='row px-2'>
						<div className='col-12 col-md-6 py-3 content'>
							<h2>About SJCE Mysore </h2>
							<p>
								SJCE Mysore is a top-grade engineering
								institute functioning from its Campus located at Mansagangothri Mysore.
								 The Institute has an area of 102 acres lush green campus with modern
				...
				<div className='container'>
					<div className='row'>
						<div className='col-12'>
							...
							<p>
								SJCE Mysore facilitates the students with the opportunities
