  ...
  const handleplacedlist = () => {
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'placedlist.xlsx',
      }).click();
    });
  };
  
  
  const handleplacedBranchWise = () => {
    fetch(
      apiLink+"stats/download/placedBranchWise/" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'BranchWiseLIST.xlsx',
      }).click();
    });
  };
  
  
  const handleplacedGenderwise = () => {
    fetch(
      apiLink+"stats/download/placedGenderwise/" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'Genderwise LIST.xlsx',
      }).click();
    });
  };
  
  
  const handleplacedCategoryWise = () => {
    fetch(
      apiLink+"stats/download/placedCategoryWise/" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'CategoryWise LIST.xlsx',
      }).click();
    });
  };
  
  
  const handlecompanyregperstudent = () => {
    fetch(
      apiLink+"stats/download/companyregperstudent/" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'companyregperstudent LIST.xlsx',
      }).click();
    });
  }; 
  
  
  const handledownloadentireplacedlist = () => {
    fetch(
      apiLink+"stats/download/downloadentireplacedlist" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'downloadentireplacedlist LIST.xlsx',
      }).click();
    });
  };
  
  const handledownloadnotregisteredyet = () => {
    fetch(
      apiLink+"stats/download/downloadnotregisteredyet" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'downloadnotregisteredyet LIST.xlsx',
      }).click();
    });
  };

  const handledownloadeligibilitysheet = () => {
    fetch(
      apiLink+"stats/download/eligibilitysheet/" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'handledownloadeligibilitysheet LIST.xlsx',
      }).click();
    });
  };
  
  const handledownloadofferperstudent = () => {
    fetch(
      apiLink+"stats/download/offerperstudent/{cid}" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'offerperstudent.xlsx',
      }).click();
    });
  };
  
  const handledownloadtier1detailed = () => {
    fetch(
      apiLink+"stats/download/tier1detailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'tier1detailed.xlsx',
      }).click();
    });
  };
  
  const handledownloadtier2detailed = () => {
    fetch(
      apiLink+"stats/download/tier2detailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'tier2detailed.xlsx',
      }).click();
    });
  };
  
  const handledownloaddreamdetailed = () => {
    fetch(
      apiLink+"stats/download/dreamdetailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'dreamdetailed.xlsx',
      }).click();
    });
  };
  
  const handledownloadcoredetailed = () => {
    fetch(
      apiLink+"stats/download/coredetailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'coredetailed.xlsx',
      }).click();
    });
  };
  
  const handledownloadspecialdetailed = () => {
    fetch(
      apiLink+"stats/download/specialdetailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'specialdetailed.xlsx',
      }).click();
    });
  };
  
  const handledownloadinterndetailed = () => {
    fetch(
      apiLink+"stats/download/interndetailed" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'interndetailed.xlsx',
      }).click();
    });
  };
  
  const handledownloadtier1short = () => {
    fetch(
      apiLink+"stats/download/tier1short" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'tier1short.xlsx',
      }).click();
    });
  };
  
  const handledownloadtier2short = () => {
    fetch(
      apiLink+"stats/download/tier2short" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'tier2short.xlsx',
      }).click();
    });
  };
  
  const handledownloaddreamshort = () => {
    fetch(
      apiLink+"stats/download/dreamshort" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'dreamshort.xlsx',
      }).click();
    });
  };
  
  const handledownloadcoreshort = () => {
    fetch(
      apiLink+"stats/download/coreshort" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'coreshort.xlsx',
      }).click();
    });
  };
  
  const handledownloadspecialshort = () => {
    fetch(
      apiLink+"stats/download/specialshort" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
    ...
    .then((href) => {
      Object.assign(document.createElement('a'), {
        href,
        download: 'specialshort.xlsx',
      }).click();
    });
  };
  
  const handledownloadinternshort = () => {
    fetch(
      apiLink+"stats/download/internshort" ,
      {
        method: "GET",
        headers: {
          'accept': "application/json",
...
<div style={{width:'100%',display:'flex',alignItems:'center'}}>
      ...
      <Box sx={{  margin: '5vh 0' }}>
            <div className='header_company'>ANALYTICS</div>
          ...
          <Button variant="contained" onClick={handleplacedlist}>Download</Button>
            ...
            Unregistered
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              PLACED BRANCH WISE LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handleplacedBranchWise}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              PLACED GENDER WISE LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handleplacedGenderwise}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              PLACED CATEGORY WISE LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handleplacedCategoryWise}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              COMPANY REGISTER PER STUDENT LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handlecompanyregperstudent}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              DOWNLOAD ENTIRE PLACED LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadentireplacedlist}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          <Typography 
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                              DOWNLOAD NOT REGISTERED YET LIST :
                          </Typography>
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadnotregisteredyet}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadeligibilitysheet}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadofferperstudent}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadtier1detailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadtier1short}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadtier2detailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadtier2short}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloaddreamdetailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloaddreamshort}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadcoredetailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadcoreshort}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadspecialdetailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadspecialshort}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadinterndetailed}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
                      ...
                      <Accordion expanded={expanded === 'panel1'} >
                        {/* add onchange version */}
                          ...
                          sx={{ width:'100%',display:'flex',alignItems:'center',justifyContent:'spaceBetween', flexShrink: 1 }}>
                            ...
                            <Stack direction="row" spacing={2}>
          <Button variant="contained" onClick={handledownloadinternshort}>Download</Button>
          {/* <Button variant="contained" onClick={handleunregisterdowload}>
            Unregistered
          </Button> */}
        </Stack>
